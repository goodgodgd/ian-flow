...
![qtdesigner](/ian-flow/assets/2019-04-20-intro-pyqt5/qtdesigner.png)
...
![signal-slot](/ian-flow/assets/2019-04-20-intro-pyqt5/signal-slot.png)
...
![window-button](/ian-flow/assets/2019-04-20-intro-pyqt5/window-button.png)
...
![qt doc](/ian-flow/assets/2019-04-20-intro-pyqt5/qt-doc.png)
...
5. MainWindow 설정: 우측 Property Editor에서 `geometry` 항목을 펼쳐서 `Width, Height` 항목 숫자 조절 (300, 200), `windowTitle`은 "PyQt: Basic button event"로 설정
   ...
   ![property_editor](/ian-flow/assets/2019-04-20-intro-pyqt5/property_editor.png)

6. GUI 객체 추가: `PushButton` 2개와 `Label` 1개 추가

7. 기본 텍스트 수정: 각 객체를 더블 클릭 후 "Hello", "닫기", "Hello PyQt" 등의 기본 텍스트 입력

   ![gui](/ian-flow/assets/2019-04-20-intro-pyqt5/gui.png)

8. 객체 이름 수정: 우측 Object Inspector 창에서 세 객체의 이름을 `btn_print, btn_close, label_print`로 수정

   ![object_inspector](/ian-flow/assets/2019-04-20-intro-pyqt5/object_inspector.png)
